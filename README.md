...
- Afiliações na Universidade da Carolina do Norte em Charlotte (UNC Charlotte):
    1. [Laboratório de Filoinformática](https://phyloinformatics.com/)
    2. Departamento de Bioinformática e Genômica (BiG), Colégio de Computação e Informática (CCI)
    3. Centro de Computação Inteligente para Prevenção de Ricos para Saúde e Meio Ambiente (CIPHER)
...
Este trabalho está licenciado sob a licença [Creative Commons Atribuição-NãoComercial 4.0 Internacional (CC-BY-NC 4.0)](https://creativecommons.org/licenses/by-nc/4.0/deed.pt_BR).