...
\begin{description}
    \item[Newick] Adotado por programas como GARLI, MrBayes, PAUP*, PHYLIP, PROTML e TREE-PUZZLE. Terminais são separados por vírgulas e as relações de grupo-irmão por parênteses aninhados. Suporta comprimentos de ramo e rótulos de nós internos:

    \begin{center}
        \texttt{((A:5,B:7)Ancestral:10,C:3);}\\
    \end{center}
